...
### Frontend changes
- **New screen:** A form where the user picks Workspace, enters RequestedFor, RequestedBy, LMApprover, RequestReason, and submits. On submit, call the create API; then show success and go back to the list or refresh.
